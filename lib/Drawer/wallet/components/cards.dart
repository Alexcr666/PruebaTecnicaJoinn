...
import 'package:dj_mania/Drawer/wallet/widgets/creditCard.dart';
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text('Your Cards', style: ThemeStyles.primaryTitle.copyWith(color: AppColors().textColorGeneral)),
            ...
            child: Row(
              ...
              children: [
                for (int i = 0; i < cardList.length; i++)
                  if (_currentCard == i) DotIndicator(true) else DotIndicator(false)
              ],
            ),
          )
        ],
